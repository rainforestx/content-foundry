...
| C4 | Body, Fig 2, FAQ 4 | NHS Phonak (sometimes branded Nathos Nova) is AirStream-equipped as a family - never platform-tied; NHS provision varies by region and some fittings use models without AirStream | CONV sec 5 NHS rule (LAW: "AirStream-equipped", no platform name); LISTING NHS panel + caveat | CONFIRMED-substrate (rule-compliant framing) |
